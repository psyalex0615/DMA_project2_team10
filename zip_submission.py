...
TEAM_NUMBER = 1 # Change this to your actual team number if different!
    ...
    for folder in folders_to_include:
        ...
        for root, dirs, files in os.walk(folder):
            ...
            for file in files:
                ...
                # Skip temp/log files
                if file.endswith('.log') or file.endswith('.tmp') or file.startswith('MAIN.tmp'):
                    continue
...
print("Please compile your 'DMA_project2_team01_보고서.md' to 'DMA_project2_team01_보고서.pdf' and add it and the presentation slides to this zip before final submission.")
